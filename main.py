...
Label(root,text = "Youtube Video Downloader",font=("Poppins bold",20),foreground = "red",bg="#26242f").pack()
Label(root,text = "Enter your Link here : ", font = "poppins",foreground = "white",bg="#26242f").place(x = 10,y = 75,anchor = NW)
userLink = StringVar()
Entry(root,textvariable = userLink, font=("poopins",10)).place(x = 225,y = 85,anchor = NW, width = 285)
Label(root,text = "Select path : ", font = "poppins",bg="#26242f",foreground = "white").place(x = 10,y = 110,anchor = NW)
Button(root,text = "Browse", command = getDirectory).place(x = 145,y = 116,anchor = NW,)
